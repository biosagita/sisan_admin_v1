...
<thead>
	<tr>
		   ...
		   <th data-options="field:'id_waktu_layanan',title:'<b>ID%20Waktu%20Layanan</b>',width:80,sortable:true" halign="center"></th>
           
		   <th data-options="field:'waktu_awal_1',title:'<b>Waktu%20Awal%201</b>',width:120,sortable:true" halign="center"></th>
           
		   <th data-options="field:'waktu_akhir_1',title:'<b>Waktu%20Akhir%201</b>',width:120,sortable:true" halign="center"></th>
           
		   <th data-options="field:'waktu_awal_2',title:'<b>Waktu%20Awal%202</b>',width:120,sortable:true" halign="center"></th>
           
		   <th data-options="field:'waktu_akhir_2',title:'<b>Waktu%20Akhir%202</b>',width:120,sortable:true" halign="center"></th>
           
		   <th data-options="field:'waktu_awal_3',title:'<b>Waktu%20Awal%203</b>',width:120,sortable:true" halign="center"></th>
           
		   <th data-options="field:'waktu_akhir_3',title:'<b>Waktu%20Akhir%203</b>',width:120,sortable:true" halign="center"></th>
