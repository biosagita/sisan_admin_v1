...
class mo_layanan extends CI_Model {
	...
	function fnlayananData($playananKeyword,$pOffset,$pRows,$pSort,$pOrder) {
		...
		$this->db->Select("d.waktu_awal_1, d.waktu_akhir_1, d.waktu_awal_2, d.waktu_akhir_2, d.waktu_awal_3, d.waktu_akhir_3, id_layanan,nama_layanan,b.nama_group_layanan,c.nama_group_layanan as forward,layanan_status,a.keterangan,a.stok,a.status_popup,a.estimasi");
