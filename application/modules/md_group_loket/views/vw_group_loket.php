...
<table id="80_dtggroup_loket" class="easyui-datagrid" data-options="title:'Group Loket',url:'<?php echo base_url(); ?>index.php/md_group_loket/fngroup_loketData/',toolbar:'#80_tlbgroup_loket',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
