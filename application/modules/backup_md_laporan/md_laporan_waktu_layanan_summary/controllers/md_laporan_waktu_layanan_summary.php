...
class md_laporan_waktu_layanan_summary extends MX_Controller {
	...
	function fntransaksiData() {
		...
		$vResult=array();
		$vRs=$this->mo_laporan_waktu_layanan_summary->fntransaksiCount($vStartKeyword,$vFinishKeyword,$vPilihanKeyword,$vUnitTimeKeyword);
		$vResult["total"]=$vRs;
		$vResult["rows"]=$this->mo_laporan_waktu_layanan_summary->fntransaksiData($vStartKeyword,$vFinishKeyword,$vPilihanKeyword,$vUnitTimeKeyword,$vOffset,$vRows,$vSort,$vOrder);		
...
//===========Print Report================================================
	...
	function fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vPilihanKeyword,$vUnitTimeKeyword){
         ...
         $data_master['data_master'] = $this->mo_laporan_waktu_layanan_summary->fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vPilihanKeyword,$vUnitTimeKeyword);        		   
