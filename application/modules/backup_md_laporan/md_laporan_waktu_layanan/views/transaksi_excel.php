...
print"<table width=100%>
			...
			<tr><th><font size=12px>Data Laporan Waktu Layanan Antrian</font><BR> 
		</table>";
print"<p></p>";
$tgl=date("d-m-Y");
print"<table width=100%>
...
foreach($data_master as $data_master_result):
  	print"<tr>
  			...
  			<td align=center >".$data_master_result['id_layanan']."
