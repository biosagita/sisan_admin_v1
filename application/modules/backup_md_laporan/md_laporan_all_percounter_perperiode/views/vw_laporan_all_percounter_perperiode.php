<div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center',title:'Laporan Antrian'" style="padding:5px;background-color:#efefef;">
					...
					<table id="54_dtglaporan" class="easyui-datagrid" data-options="title:'',url:'<?php echo base_url(); ?>index.php/md_laporan_all_percounter_perperiode/fntransaksiData/',toolbar:'#54_tlblaporan',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
					<thead>
						<tr>
...
function fnPrint_transaksi( title,w,h) {
		...
		var finishKeyword = $('#54finishdate').datebox('getValue');
			...
			var targetWin = window.open ('index.php/md_laporan_all_percounter_perperiode/fntransaksiDataPrint/'+startKeyword+'/'+finishKeyword, title, 'toolbar=yes, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
