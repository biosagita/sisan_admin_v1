<?php
class md_laporan_all_percounter_perperiode extends MX_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('mo_laporan_all_percounter_perperiode');
	...
	function fnlaporan()	{
		$this->load->view('vw_laporan_all_percounter_perperiode');
	}
	...
	function fntransaksiData() {
		...
		$vResult=array();
		$vRs=$this->mo_laporan_all_percounter_perperiode->fntransaksiCount($vcityKeyword,$vkecKeyword,$vstatusKeyword,$vEmpId);
		$vResult["total"]=$vRs->selectCount;
		$vResult["rows"]=$this->mo_laporan_all_percounter_perperiode->fntransaksiData($vStartKeyword,$vFinishKeyword,$vOffset,$vRows,$vSort,$vOrder);		
...
//===========Print Report================================================
	...
	function fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword){
         ...
         $data_master['data_master'] = $this->mo_laporan_all_percounter_perperiode->fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword);        		   
