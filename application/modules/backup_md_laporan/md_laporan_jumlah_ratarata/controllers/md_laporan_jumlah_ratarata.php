<?php
class md_laporan_jumlah_ratarata extends MX_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('mo_laporan_jumlah_ratarata');
	...
	function fnlaporan()	{
		$this->load->view('vw_laporan_jumlah_ratarata');
	}
	...
	function fntransaksiData() {
		...
		$vResult=array();
		$vRs=$this->mo_laporan_jumlah_ratarata->fntransaksiCount($vcityKeyword,$vkecKeyword,$vstatusKeyword,$vEmpId);
		$vResult["total"]=$vRs->selectCount;
		$vResult["rows"]=$this->mo_laporan_jumlah_ratarata->fntransaksiData($vStartKeyword,$vFinishKeyword,$vOffset,$vRows,$vSort,$vOrder);		
...
//===========Print Report================================================
	...
	function fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword){
         ...
         $data_master['data_master'] = $this->mo_laporan_jumlah_ratarata->fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword);        		   
