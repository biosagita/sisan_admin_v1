<?php
class mo_laporan_jumlah_ratarata extends CI_Model {
	...
	function fntransaksiData($vStartKeyword,$vFinishKeyword,$vOffset,$vRows,$vSort,$vOrder) {
		...
		$this->db->group_by(array("a.tanggal_transaksi","a.id_loket"));
		...
		foreach($vResult as $vRow):		
			...
			$vArrayTemp['id_loket'] = !empty($vRow->nama_loket) ? $vRow->nama_loket : '-';

			$vArrayTemp['rata-rata'] = '-';		
