<?php
class md_laporan_counter extends MX_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('mo_laporan_counter');
	...
	function fnlaporan()	{
		$this->load->view('vw_laporan_counter');
	}
	...
	function fntransaksiData() {
		...
		$vResult=array();
		$vRs=$this->mo_laporan_counter->fntransaksiCount($vStartKeyword,$vFinishKeyword);
		$vResult["total"]=$vRs->selectCount;
		$vResult["rows"]=$this->mo_laporan_counter->fntransaksiData($vStartKeyword,$vFinishKeyword,$vOffset,$vRows,$vSort,$vOrder);		
...
//===========Print Report================================================
	...
	function fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword){
         ...
         $data_master['data_master'] = $this->mo_laporan_counter->fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword);        		   
