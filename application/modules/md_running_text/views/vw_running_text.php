<div id="87_tlbrunning_text" style="padding:5px;">
	...
	<div style="float:right;clear:right;">
		<span>Search:</span>
		<input id="87_txtheader" style="width:175px;line-height:26px;border:1px solid #CCCCCC; padding:3px">
		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="fnSearch_87()">Find</a>
	</div>
</div>

			<table id="87_dtgrunning_text" class="easyui-datagrid" data-options="title:'Running Text',url:'<?php echo base_url(); ?>index.php/md_running_text/fnrunning_textData/',toolbar:'#87_tlbrunning_text',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
			<thead>
				<tr>
