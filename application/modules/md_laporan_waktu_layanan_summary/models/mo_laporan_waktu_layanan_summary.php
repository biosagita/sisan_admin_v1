...
class mo_laporan_waktu_layanan_summary extends CI_Model {
	...
	function fntransaksiCount($vStartKeyword,$vFinishKeyword,$vLayananKeyword,$vLoketKeyword,$vUserKeyword,$vPilihanKeyword,$vUnitTimeKeyword) {
	...
	function fntransaksiData($vStartKeyword,$vFinishKeyword,$vLayananKeyword,$vLoketKeyword,$vUserKeyword,$vPilihanKeyword,$vUnitTimeKeyword,$vOffset,$vRows,$vSort,$vOrder) {
		$tgl_periode = '';
...
//==========Print Report=======	
	...
	function fntransaksiDataPrint($vStartKeyword,$vFinishKeyword,$vLayananKeyword,$vLoketKeyword,$vUserKeyword,$vPilihanKeyword,$vUnitTimeKeyword) {
		$tgl_periode = '';
