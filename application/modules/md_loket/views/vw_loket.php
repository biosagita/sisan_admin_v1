...
<table id="81_dtgloket" class="easyui-datagrid" data-options="title:'Loket',url:'<?php echo base_url(); ?>index.php/md_loket/fnloketData/',toolbar:'#81_tlbloket',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id_loket',title:'<b>Id</b>',hidden:true,width:40,sortable:true" halign="center"></th>

		   <th data-options="field:'jenis_loket',title:'<b>Jenis Loket</b>',width:200,sortable:true" halign="center"></th>
