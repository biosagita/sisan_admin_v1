...
function fnPrint_transaksi( title,w,h) {
		...
		var finishKeyword = $('#54finishdate').datebox('getValue');
			...
			var targetWin = window.open ('index.php/md_laporan_all_detail/fntransaksiDataPrint/'+startKeyword+'/'+finishKeyword, title, 'toolbar=yes, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
