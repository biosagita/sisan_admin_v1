...
class md_laporan_all_detail extends MX_Controller {
	...
	function fnlaporan()	{
		$this->load->view('vw_laporan_all_detail');
	}
	...
	function fntransaksiData() {
		...
		$vResult=array();
		$vRs=$this->mo_laporan_all_detail->fntransaksiCount($vcityKeyword,$vkecKeyword,$vstatusKeyword,$vEmpId);
		$vResult["total"]=$vRs->selectCount;
		$vResult["rows"]=$this->mo_laporan_all_detail->fntransaksiData($vStartKeyword,$vFinishKeyword,$vOffset,$vRows,$vSort,$vOrder);		
...
//===========Print Report================================================
	...
	function fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword){
         ...
         $data_master['data_master'] = $this->mo_laporan_all_detail->fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vstatusKeyword);        		   
