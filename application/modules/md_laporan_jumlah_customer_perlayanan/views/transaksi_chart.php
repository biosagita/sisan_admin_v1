...
<html>
    ...
    <body>
        <div style="width: 960px;margin:auto;">
            ...
            <h3 style="text-align:center;">Chart Jumlah Customer Antrian</h3>
    ...
    var barChartData = {
        ...
        datasets : [
        {
            ...
            {
                fillColor : "<?php echo $result['listwarna'][1][0]; ?>",
                strokeColor : "<?php echo $result['listwarna'][1][1]; ?>",
                highlightFill : "<?php echo $result['listwarna'][1][2]; ?>",
                highlightStroke : "<?php echo $result['listwarna'][1][3]; ?>",
                data : [<?php echo implode(',', $result['list_y2']); ?>],
                label : "<?php echo $result['legend'][0]; ?>"
            },
            {
                fillColor : "<?php echo $result['listwarna'][2][0]; ?>",
                strokeColor : "<?php echo $result['listwarna'][2][1]; ?>",
                highlightFill : "<?php echo $result['listwarna'][2][2]; ?>",
                highlightStroke : "<?php echo $result['listwarna'][2][3]; ?>",
                data : [<?php echo implode(',', $result['list_y3']); ?>],
                label : "<?php echo $result['legend'][0]; ?>"
            }
        ]
