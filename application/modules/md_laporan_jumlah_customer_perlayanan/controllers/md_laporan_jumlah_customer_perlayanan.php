...
//===========Print Report================================================
	...
	function fntransaksiDataPrint($vcityKeyword,$vkecKeyword,$vLayananKeyword,$vLoketKeyword,$vUserKeyword,$vPilihanKeyword,$excel=true){
         ...
         $data_master['data_company'] = $this->mo_laporan_jumlah_customer_perlayanan->getDataCompany();
   ...
   function fntransaksiDataPrintChart($vcityKeyword,$vkecKeyword,$vLayananKeyword,$vLoketKeyword,$vUserKeyword,$vPilihanKeyword) {
		
		$vData['result'] = $this->mo_laporan_jumlah_customer_perlayanan->fntransaksiDataPrintChart($vcityKeyword,$vkecKeyword,$vLayananKeyword,$vLoketKeyword,$vUserKeyword,$vPilihanKeyword);
		$vData['data_company'] = $this->mo_laporan_jumlah_customer_perlayanan->getDataCompany();
