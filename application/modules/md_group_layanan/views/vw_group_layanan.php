...
<table id="78_dtggroup_layanan" class="easyui-datagrid" data-options="title:'Group Layanan',url:'<?php echo base_url(); ?>index.php/md_group_layanan/fngroup_layananData/',toolbar:'#78_tlbgroup_layanan',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
		   ...
		   <th data-options="field:'no_awal',title:'<b>No Awal</b>',width:200,sortable:true" halign="center"></th>
