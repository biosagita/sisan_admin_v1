...
<div id="tree" style="float:left;" >
		...
		?>
			...
			<li iconCls="icon-gears"><span><a href="javascript:void(0)" style="font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#dd6600" onclick="specialFeature()"><strong>Logout</strong></a></span>
			</li>
		</ul>
</div>
